...
export default defineEventHandler(async (event) => {
  ...
  for (const staticEndpoint of staticEndpoints) {
    if (staticEndpoint === '/a-dummy-page-to-force-nuxt-content-crawler-to-crawl-projects')
      continue
...
/**
 * Recursively get all files from the pages folder.
 */
