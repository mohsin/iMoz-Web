...
<template>
  <div @click="entry.isClosed = !entry.isClosed" v-for="entry in data" v-bind:key="entry.company" class="block p-6 sm:mx-2 shadow-lg bg-white dark:bg-slate-700 w-full mt-6">
